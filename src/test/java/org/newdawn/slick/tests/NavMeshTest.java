...
public class NavMeshTest extends BasicGame implements PathFindingContext {
	...
	/*
	 * (non-Javadoc)
	 * @see org.newdawn.PathFindingContext#getMover()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.newdawn.PathFindingContext#getSearchDistance()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.newdawn.PathFindingContext#getSourceX()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.newdawn.PathFindingContext#getSourceY()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.newdawn.BasicGame#mousePressed(int, int, int)
	 */
	...
	private class DataMap implements TileBasedMap {
		...
		/*
		 * (non-Javadoc)
		 * @see org.newdawn.TileBasedMap#blocked(org.newdawn.PathFindingContext, int, int)
		 */
		...
		/*
		 * (non-Javadoc)
		 * @see org.newdawn.TileBasedMap#getCost(org.newdawn.PathFindingContext, int, int)
		 */
		...
		/*
		 * (non-Javadoc)
		 * @see org.newdawn.TileBasedMap#getHeightInTiles()
		 */
		...
		/*
		 * (non-Javadoc)
		 * @see org.newdawn.TileBasedMap#getWidthInTiles()
		 */
		...
		/*
		 * (non-Javadoc)
		 * @see org.newdawn.TileBasedMap#pathFinderVisited(int, int)
		 */
