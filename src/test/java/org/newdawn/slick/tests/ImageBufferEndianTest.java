...
public class ImageBufferEndianTest extends BasicGame {
   ...
   /*
    * (non-Javadoc)
    * @see org.newdawn.Game#render(org.newdawn.GameContainer, org.newdawn.Graphics)
    */
   ...
   /*
    * (non-Javadoc)
    * @see org.newdawn.BasicGame#init(org.newdawn.GameContainer)
    */
   ...
   /*
    * (non-Javadoc)
    * @see org.newdawn.BasicGame#update(org.newdawn.GameContainer, int)
    */
