...
public abstract class ControlPanel extends DefaultPanel implements InputPanelListener {
	...
	/**
	 * @see InputPanelListener#minMaxUpdated(org.newdawn.slick.tools.peditor.MinMaxPanel)
	 */
	...
	/**
	 * @see InputPanelListener#valueUpdated(org.newdawn.slick.tools.peditor.ValuePanel)
	 */
