...
public class ImmediateModeOGLRenderer implements SGL {
	...
	/*
	 * (non-Javadoc)
	 * @see org.newdawn.SGL#glGenTextures(java.nio.IntBuffer)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.newdawn.SGL#glGetError()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.newdawn.SGL#glTexImage2D(int, int, int, int, int, int, int, int, java.nio.ByteBuffer)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.newdawn.SGL#canTextureMirrorClamp()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.newdawn.SGL#canSecondaryColor()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.newdawn.SGL#glSecondaryColor3ubEXT(byte, byte, byte)
	 */
